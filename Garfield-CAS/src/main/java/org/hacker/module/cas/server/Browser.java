...
/**
 * Browser 是用于保存 app-url 和 browserAndApplicationSessionId 配合SSO登出的POJO
 * 
 * @author Mr.J.
 * 
 * @since 2015.07.11
...
public class Browser {
  ...
  public void setBrowserAndApplicationSessionId(String browserAndApplicationSessionId) {
    this.browserAndApplicationSessionId = browserAndApplicationSessionId;
  }
